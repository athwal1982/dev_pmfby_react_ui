...
const ForgotPassworddN = ({ showfunc, setSelectedOption, selectedOption }) => {
                ...
                <>
                  ...
                  {!otpVisible && (
                    <>
                      ...
                      <button onClick={handleGetOTP} className="get-otpN" disabled={loading}>
                  ...
                  {otpVisible && (
                    <div style={{ marginTop: "10px" }}>
                      ...
                      <button onClick={handleSubmitOtp} className="get-otpN">
                        Submit OTP{" "}
                      </button>
                    </div>
                  )}
                    ...
                    <div className="password-inputN">
                      ...
                      <div className="input-containerN">
                        ...
                        {revealConfirmPassword ? (
                          <VscEyeClosed className="password-iconN" onClick={() => toggleConfirmPassword()} />
                        ) : (
                          <VscEye className="password-iconN" onClick={() => toggleConfirmPassword()} />
                        )}
                      </div>
                    </div>
                    <button type="button" className="get-otpN" onClick={handleConfirm} disabled={isProcessing}>
                      {" "}
                      Submit{" "}
                    </button>
                  </div>
...
export default ForgotPassworddN;
