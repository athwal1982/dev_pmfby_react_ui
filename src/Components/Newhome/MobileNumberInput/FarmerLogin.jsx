...
const FarmerLogin = ({ handleOtpSent }) => {
        ...
        <>
          {!isVerificationComplete ? (
            <>
              ...
              {otpFieldVisible && (
                <div className="otp-captcha-fields">
            ...
            <FormControl className="form-container">
              <FormLabel id="demo-controlled-radio-buttons-group" className="form-label">
                Select module
              </FormLabel>
              ...
              >
                <FormControlLabel
                  ...
                  className={`radio-button ${value === "ComplaintStatus" ? "selected" : ""}`}
                />
                ...
                <FormControlLabel
                  ...
                  className={`radio-button ${value === "ClaimIntimation" ? "selected" : ""}`}
                />
              </RadioGroup>
              <button
                className="get-otp"
