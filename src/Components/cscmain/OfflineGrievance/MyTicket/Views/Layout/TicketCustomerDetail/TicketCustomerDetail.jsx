      ...
      <div className={BizClass.MainBox}>
        <div className={BizClass.InfoBox}>
          <div className={BizClass.SubBox}>
            ...
            <p>
              Representation Type :
              <span id="spnRepresentationType">{ticketData.RepresentationType && ticketData.RepresentationType === "SINGLE" ? "Individual Representation" : ticketData.RepresentationType === "MULTIPLE" ? "Joint Representation" : ""}
              </span>
            </p>
