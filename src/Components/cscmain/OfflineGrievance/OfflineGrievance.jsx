  ...
  const getGrievenceTicketsDataList = async () => {
    try {
      ...
      const requestData = {
        ...
        receiptSourceID:
          formValues.txtSourceOfReceipt && formValues.txtSourceOfReceipt.CommonMasterValueID ? formValues.txtSourceOfReceipt.CommonMasterValueID : 0,
    ...
    <>
      ...
      <div className={BizClass.Box}>
        <div className={BizClass.PageBar}>
          {addTicketRight ? (
            <PageBar.Button onClick={() => openAddOfflineGrievancePage()} title="Add Grievance From Other Sources">
