      ...
      if (result.responseCode === 1) {
        if (result && result.responseData) {
          selectedData.InsuranceCompanyID =
            formValues.txtInsuranceCompany && formValues.txtInsuranceCompany.CompanyID ? formValues.txtInsuranceCompany.CompanyID : 0;
          (selectedData.InsuranceCompany =
            formValues.txtInsuranceCompany && formValues.txtInsuranceCompany.CompanyName ? formValues.txtInsuranceCompany.CompanyName : ""),
