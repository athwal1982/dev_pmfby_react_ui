...
function InsuranceCompLogics() {
  ...
  useEffect(() => {
    ...
    // A getChartCategoryWiseDataInsuranceComp(2, userData && userData.LoginID ? userData.LoginID : 0, "BYCTZ", "");
    // A getChartInsuranceCompanyDataInsuranceComp(1, userData && userData.LoginID ? userData.LoginID : 0, "BYINS","");
    // A getChartDailyTicketsActivityDataInsuranceComp(1, userData && userData.LoginID ? userData.LoginID : 0, "BYSTS", "");
    // A getChartLastMonthDataInsuranceComp(2, userData && userData.LoginID ? userData.LoginID : 0, "BYDUR", "");
    // A getChartTypeWiseData(2, userData && userData.LoginID ? userData.LoginID : 0, "BYHDR", "");
