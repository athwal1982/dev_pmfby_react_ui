    ...
    <Modal varient="half" title="SosAgeing Ticket Details" show={openSosAgeingTicketListClick} right="0" width="75vw">
      <Modal.Body>
        <div className={BizClass.Card}>
          <PageBar>
            <PageBar.Search />
            <PageBar.ExcelButton onClick={() => exportSosAgeingTicketListClick()} disabled={SosAgeingTicketCountList.length === 0}>
              Export
            </PageBar.ExcelButton>
          </PageBar>
          <DataGrid rowData={SosAgeingTicketCountList} loader={isLoadingSosAgeingTicketCountList ? <Loader /> : false}>
...
export default SosAgeingTicketList;
