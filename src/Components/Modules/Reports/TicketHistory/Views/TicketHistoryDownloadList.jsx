...
function TicketHistoryDownloadList({ toggleDownloadHistoryListModal, trainingDetails }) {
  ...
  const onClickDeleteAssignedCenter = async (data) => {
    ...
    try {
      const formdata = {
        ...
        SPTraningMasterID: trainingDetails && trainingDetails.TrainingMasterId ? trainingDetails.TrainingMasterId : 0,
  ...
  return (
    <>
      <Modal varient="half" title="Ticket History Download" right={0} width="70vw" height="100vh" show={toggleDownloadHistoryListModal}>
        <Modal.Body>
          <div className="PageStart">
            ...
            >
              ...
              <DataGrid.Column
                ...
                valueGetter={(node) => {
                  return node.data.RequestCreationDate ? dateToSpecificFormat(`${node.data.RequestCreationDate.split("T")[0]}`, "DD-MM-YYYY") : null;
                }}
              />
              ...
              <DataGrid.Column
                ...
                valueGetter={(node) => {
                  return node.data.RequestedParamsFromDate ? dateToSpecificFormat(node.data.RequestedParamsFromDate, "DD-MM-YYYY") : null;
                }}
              />
              ...
              <DataGrid.Column
                ...
                valueGetter={(node) => {
                  return node.data.RequestedParamsToDate ? dateToSpecificFormat(node.data.RequestedParamsToDate, "DD-MM-YYYY") : null;
                }}
              />
            </DataGrid>
          </div>
