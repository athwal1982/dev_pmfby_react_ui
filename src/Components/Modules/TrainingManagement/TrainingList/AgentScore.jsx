...
function AgentScore({ toggleAgentScoreModal, trainingDetails }) {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const formdata = {
        ...
        SPTrainingMasterID: trainingDetails && trainingDetails.TrainingMasterId ? trainingDetails.TrainingMasterId : 0,
  ...
  return (
    <>
      <Modal varient="half" title="Mark Assesment Score" right={0} width="55vw" height="100vh" show={toggleAgentScoreModal}>
        <Modal.Body>
            ...
            >
              ...
              <DataGrid.Column
                ...
                cellRenderer={(node) => {
                  ...
                  return <input type="text" value={node.data?.OptedMarks || ""} maxLength={3} onChange={handleChange} />;
                }}
                headerComponentParams={{
                  style: { backgroundColor: "#04540", color: "white", fontSize: "14px", textAlign: "center" },
                }}
