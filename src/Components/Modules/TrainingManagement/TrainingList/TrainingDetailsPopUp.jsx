...
function TrainingDetailsPopUp({ toggleTrainingByAdminModal, trainingDetails }) {
  ...
  const getAssignedUserListData = async (data) => {
    ...
    try {
      ...
      const formdata = {
        ...
        centerID: "0",
        trainingMasterID: trainingDetails && trainingDetails.TrainingMasterId ? trainingDetails.TrainingMasterId.toString() : "0",
        userID: "0",
  ...
  return (
    <>
      <Modal varient="half" title="Training Attendance" right={0} width="55vw" height="100vh" show={toggleTrainingByAdminModal}>
        <Modal.Body>
          <div className="PageStart">
            <div className="search-upload-wrapper">
              ...
              <input type="file" accept=".xlsx, .xls" onChange={handleExcelUpload} ref={fileInputRef} className="excel-upload-input" />

              <Button varient="secondary" onClick={handleResetGrid} className="custom-button-reset">
                Reset
              </Button>
            </div>
