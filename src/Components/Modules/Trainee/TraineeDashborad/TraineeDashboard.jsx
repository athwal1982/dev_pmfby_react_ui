...
const TraineeDashboard = () => {
  ...
  <div className="progress-header">
    <span className="progress-label">Overall Training Progress <select
                className="month-dropdown"
                value={trainingSixMonthWiseVal}
                onChange={(e) => handletrainingSixMonthWise(e)}
              >
                {trainingSixMonthWise && trainingSixMonthWise.length > 0 ? trainingSixMonthWise.map((val, i) => (
